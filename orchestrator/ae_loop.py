...
class AELoop:
    ...
    async def explore_attributes(self, 
    ...
    async def _oracle_query(self, 
        ...
        if all_accepted:
            ...
            first_rejection = next((v for v in verdicts.values() if not v.get("accepted", True)), {})
            return {
                "accepted": False,
                "verdicts": verdicts,
    ...
    async def _check_static_implication(self, implication: Implication, static_analyzer) -> Dict[str, Any]:
    ...
    async def _check_property_implication(self, implication: Implication, property_runner) -> Dict[str, Any]:
    ...
    async def _generate_from_counterexample(self, counterexample: CounterExample) -> List[Implication]:
    ...
    def _compute_closure_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_implication_confidence": sum(impl.confidence for impl in self.implications.values()) / len(self.implications) if self.implications else 0
        }
